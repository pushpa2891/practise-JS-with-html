...
6. Write a function ('printGoals')that receives an arbitrary number of player names (not an array) and prints each of them to the console along 
with the number of goals that were scored in total (number   /*of player names passed in) 
...
const game = {
    ...
    let players1Final1 = [...players1,'Thiago', 'Coutinho','Perisic'];
    //let {team1,x:draw,team2} = game.odds;
    let {odds:{team1,x:draw,team2}} = game;

    function printGoals(...args) {
       
        //args.forEach(a => document.write(a + '<br>'));
